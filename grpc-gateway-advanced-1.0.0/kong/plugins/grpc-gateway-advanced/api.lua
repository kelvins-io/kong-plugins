...
return {
  ["/grpc-gateway-advanced/proto-cache"] = {
    resource = "grpc-gateway-advanced-proto-cache",

    --- 删除所有 grpc-gateway-advanced 插件的 proto 缓存
    DELETE = function()
      local seen = {}
      local total = 0
  ...
  ["/grpc-gateway-advanced/proto-cache/:plugin_id"] = {
    resource = "grpc-gateway-advanced-proto-cache",
    ...
    DELETE = function(self)
      ...
      if plugin.name ~= "grpc-gateway-advanced" then
        return kong.response.exit(404, { message = "plugin is not grpc-gateway-advanced" })
      end
